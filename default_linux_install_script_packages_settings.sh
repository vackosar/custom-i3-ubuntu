...
sudo apt install -y terminator libreoffice vim pavucontrol xfce4-power-manager keepass2 vlc build-essential python-dev python-tk calibre ffmpeg doublecmd-qt;
